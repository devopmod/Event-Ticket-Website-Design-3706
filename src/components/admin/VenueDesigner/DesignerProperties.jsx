...
const { FiSettings, FiHash, FiSquare, FiPalette, FiTag } = FiIcons;
    ...
    <div className="bg-zinc-800 p-4 rounded-lg">
      ...
      <div className="space-y-6">
        ...
        {selectedElement.type === 'seat' && (
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">
              <SafeIcon icon={FiSquare} className="inline w-4 h-4 mr-1" />
              Size
            </label>
            <input
              type="number"
        ...
        {selectedElement.type === 'stage' && (
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">
              <SafeIcon icon={FiPalette} className="inline w-4 h-4 mr-1" />
              Color
            </label>
            <input
              type="color"
        ...
        {selectedElement.type === 'seat' && (
          <>
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-2">
                <SafeIcon icon={FiHash} className="inline w-4 h-4 mr-1" />
                Seat Number
              </label>
              <input
                type="text"
