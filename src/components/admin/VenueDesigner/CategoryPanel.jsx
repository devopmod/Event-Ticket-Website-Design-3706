    ...
    <div className="bg-zinc-800 p-4 rounded-lg">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center px-3 py-1 bg-primary-400 hover:bg-primary-500 text-black rounded-lg text-sm transition-colors"
        >
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end space-x-3 mt-6">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 bg-primary-400 hover:bg-primary-500 text-black rounded-lg transition-colors flex items-center"
                  >
