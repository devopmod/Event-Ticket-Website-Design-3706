    ...
    if (venue) {
      try {
        ...
        if (venue.canvas_data) {
          canvasData = typeof venue.canvas_data === 'string' ? JSON.parse(venue.canvas_data) : venue.canvas_data;
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                saving ? 'bg-zinc-700 text-zinc-500 cursor-not-allowed' : 'bg-primary-400 hover:bg-primary-500 text-black'
              }`}
            >
