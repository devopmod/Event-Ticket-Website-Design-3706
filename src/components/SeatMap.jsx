...
import { SEAT_STATUS, getStatusColor, getStatusText } from '../constants/seatStatus';

// Дополнительное логирование для отладки
console.log('SeatMap.jsx loaded - status constants:', SEAT_STATUS);
  ...
  const handleMouseDown = useCallback((e) => {
    ...
    const clickedSeat = elements.find(element => {
      ...
      return pos.x >= element.x && 
             pos.x <= element.x + size && 
             pos.y >= element.y && 
             pos.y <= element.y + size;
    });
