...
import {fetchVenueById,cleanupExpiredReservations} from '../services/venueService';
...
const SeatSelectionPage=()=> {
  ...
  // Load seat map data using existing services
  useEffect(()=> {
  ...
  const handleProceedToCheckout=async ()=> {
    ...
    try {
      ...
      navigate(`/checkout/${id}`,{
        state: {selectedSeats,totalPrice: grandTotal}
      });
    } catch (error) {
